...
def main():
    ...
    elif st.session_state.game_state.is_running:
        if not st.session_state.game_state.game.current_card:
            st.warning("¡Todas las cartas han sido llamadas!")
        else:
            st.info("Esperando la siguiente carta...")
